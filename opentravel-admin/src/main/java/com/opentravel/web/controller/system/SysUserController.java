...
import com.opentravel.common.core.domain.entity.SysDept;
...
import com.opentravel.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult addSave(@Validated SysUser user)
    {
        ...
        {
            return error("新增用戶'" + user.getLoginName() + "'失敗，登錄賬號已存在");
        }
        ...
        {
            return error("新增用戶'" + user.getLoginName() + "'失敗，郵箱賬號已存在");
        }
    ...
    public AjaxResult editSave(@Validated SysUser user)
    {
        ...
        if (!userService.checkLoginNameUnique(user))
        {
            return error("修改用戶'" + user.getLoginName() + "'失敗，登錄賬號已存在");
        }
        else if (StringUtils.isNotEmpty(user.getPhonenumber()) && !userService.checkPhoneUnique(user))
        {
        ...
        {
            return error("修改用戶'" + user.getLoginName() + "'失敗，郵箱賬號已存在");
        }
