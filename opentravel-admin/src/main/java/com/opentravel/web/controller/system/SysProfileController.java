...
import com.opentravel.common.utils.file.FileUploadUtils;
import com.opentravel.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
     ...
     * 修改用戶
     */
    @Log(title = "個人信息", businessType = BusinessType.UPDATE)
    @PostMapping("/update")
    @ResponseBody
    public AjaxResult update(SysUser user)
    {
        ...
        {
            return error("修改用戶'" + currentUser.getLoginName() + "'失敗，郵箱賬號已存在");
        }
