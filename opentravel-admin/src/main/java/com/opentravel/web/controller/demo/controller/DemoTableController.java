...
import com.opentravel.common.annotation.Excel.ColumnType;
...
public class DemoTableController extends BaseController
{
    ...
    private final static List<AreaModel> areas = new ArrayList<AreaModel>();
    {
        ...
        areas.add(new AreaModel(7, 0, "陜西省", "610000", "SXS", "ShanXiSheng", 0));
    ...
    private final static List<UserTableColumn> columns = new ArrayList<UserTableColumn>();
    {
        ...
        columns.add(new UserTableColumn("用戶郵箱", "userEmail"));
        columns.add(new UserTableColumn("用戶狀態", "status"));
    }

    private final static List<DocumentModel> documents = new ArrayList<DocumentModel>();
    {
        documents.add(new DocumentModel(1, "247-XW·2024-D10-0001", "新聞熱線[2024]000001", "索尼射擊遊戲《Concord》停止運營，玩家將獲全額退款", "索尼宣布多人射擊遊戲《Concord》將於9月6日停止運營，玩家將獲得全額退款。遊戲總監Ryan Ellis在給玩家的信中表示，這款遊戲首次發布“並沒有像我們預期的那樣順利”。《Concord》的開發歷時8年，投資超過1.5億美元。遊戲在Steam平台的售價為40美元，采用買斷制銷售模式。據SteamDB統計，遊戲上市後的最高同時在線人數為697人。"));
        documents.add(new DocumentModel(2, "247-XW·2024-D30-0002", "新聞熱線[2024]000002", "網紅賬號被封，央媒：如此炫富毒瘤早就該拔了", "在社交平台上分享自己的生活日常，本來無可厚非。但無底線地展示物欲、宣揚拜金，取笑甚至嘲諷工薪者的煙火生活，就會遮蔽普通人的平凡質樸和堅韌奮鬥，在無形中消解蕓蕓眾生腳踏實地、自立自強的社會正氣。對這種助長金錢至上、刺激公眾焦慮，既汙染網絡生態，又撕裂社會和諧的炫富“毒瘤”，必須堅決拔除之。在國家有關部門的部署下，近日，多個網絡平台開展“不良價值導向內容專項治理”行動，對“奢靡浪費”“炫富拜金”等問題從嚴打擊，倡導理性、文明的消費觀和價值觀。"));
        documents.add(new DocumentModel(3, "CT01-XW·2024-Y-0003", "新聞熱線[2024]000003", "重慶一夫妻被騙至緬甸，家屬：兩人已被解救，預計很快能回國", "5月25日，重慶一對夫妻在前往泰國後失聯，疑被詐騙集團騙至緬甸的消息引發廣泛關註。警方已對此事立案調查，而這對夫妻的親屬則每天生活在焦急和不安之中。親屬：家都癱瘓了，事情一經曝光，迅速登上了熱搜，成為公眾熱議的話題。據了解，這對夫妻原計劃是去泰國談生意，但不幸的是，他們的泰國之行變成了一場噩夢。親屬李先生透露，4月14日，他們夫妻二人抵達泰國，不久後便疑似被人以10萬元的價格賣到緬甸，目前被困在緬甸妙瓦底的一個電信詐騙園區。"));
        documents.add(new DocumentModel(4, "CT01-XW·2024-Y-0004", "新聞熱線[2024]000004", "江濱社區聯合派出所、金霞消防站開展電動自行車安全隱患夜查活動", "近日，長沙市開福區江濱社區聯合派出所、金霞消防站深入居民小區、單位場所，以電動車自行車火災防範為重點，開展消防安全夜查行動。此次夜查緊緊圍繞老舊居民區、“三合一”場所、沿街門店、夜間經營使用場所等場所開展監督檢查，重點檢查電動自行車違規停放充電、堵塞疏散通道和安全出口，架空層違規作為電動自行車停放充電場所，電動自行車違規“進樓入戶”“飛線充電”，電動自行車擅自改裝等五大類問題。"));
        ...
        documents.add(new DocumentModel(6, "CT01-XW·2024-Y-0006", "新聞熱線[2024]000006", "市場狀況充滿挑戰！極星宣布裁員全球約15%的員工", "據路透社報道，極星周五以“充滿挑戰的市場狀況”為由，宣布計劃在全球範圍內裁減約450個職位。此次裁員之際，許多人都對電動汽車需求降溫表示擔憂，而且極星預計汽車業務最早將在2025年開始實現收支平衡。極星發言人表示：“作為該商業計劃的一部分，我們需要調整我們的業務和運營規模。” “這涉及減少外部支出，遺憾的是，還包括我們的員工數量。”該公司還表示，希望減少對沃爾沃及其母公司吉利外部融資的依賴，最近還表示希望削減成本並提高電動汽車的利潤率。"));
        documents.add(new DocumentModel(7, "CT01-XW·2024-Y-0007", "新聞熱線[2024]000007", "浙江隱秘富豪涉百億非法集資案，部分資金流入新造車公司", "5月10日、11日，上海北廣投資管理有限公司（下稱“北廣投”）非法集資案在上海黃浦區人民法院一審公開開庭審理，北廣投實控人周敏、法定代表人朱江等30余名中高管被控非法吸收公眾存款罪。根據財新報道，這一案件中，非法集資的資金有部分流入了兩家新能源車企——愛馳汽車、萬象汽車。同時，有多位投資人引述與經偵部門溝通時的說法稱，該案事發時未兌付金額有130余億元，其中去往廣微控股45億元、萬象汽車63億元、愛馳汽車15億元。"));
        documents.add(new DocumentModel(8, "CT01-XW·2024-Y-0008", "新聞熱線[2024]000008", "特斯拉宣布Model Y升級：搭載HW4.0硬件，售價仍25.89萬元起", "2月1日，特斯拉官方宣布ModelY升級。外觀上，新增ModelY專屬色“快銀車漆”，並采用烈焰紅代替中國紅、星空灰代替冷光銀；性能上，ModelY全系配備全新一代自動輔助駕駛硬件(HW4.0)，通過搭載超遠距離雙目攝像頭，ModelY的最遠探測距離達424米。由此，特斯拉全系車型均配備了自動輔助駕駛硬件HW4.0。在售價方面，特斯拉中國官網顯示，ModelY車型依然保持原價。ModelY後輪驅動版25.89萬元起、ModelY長續航版29.99萬元起、ModelY高性能版售價36.39萬元起。"));
        documents.add(new DocumentModel(9, "CT01-XW·2024-D10-0009", "新聞熱線[2024]000009", "華為手機歸來，誰最受傷？", "低迷周期下的智能手機市場在2023年下半年迎來了華為的回歸，這也給本就競爭激烈的市場環境帶來了更大變數。1月29日，有消息稱，華為已註冊“星耀手機”品牌商標，定位中端手機市場，但上述消息並未獲得華為方面確認。“目前星耀的相關信息我們看到了，但是沒有獲得產品信息以及啟動線下鋪貨的通知。對於和其他品牌的二選一問題，聽其他省份的經銷商說過，但目前（華為渠道）這邊也沒有更多動作。”一位廣東區域的華為核心經銷商對記者說。但華為手機的反撲已經開始。在多家調研機構公布的2023年四季度智能手機出貨數據中，華為手機的量正在明顯上升，當季增幅在35%到47%之間。不過，從全年數據來看，並未登上前五榜單。"));
        documents.add(new DocumentModel(10, "CT01-XW·2024-D10-0010", "新聞熱線[2024]000010", "瘋狂裁員的矽谷大廠：除了AI，其它都是將就", "放眼望去，近期科技企業財報形勢一片大好，裁員浪潮卻仍在不斷蔓延。國內職場動態看脈脈，那矽谷裁員情況就得看layoff.fyi了。數據顯示，2024年，103家科技企業進行了裁員，28963位員工失去了飯碗。其中，電子支付公司PayPal大筆一揮，裁掉2500人，微軟則在開年就裁掉1900人。回望2023年，谷歌、Meta、亞馬遜、微軟均為裁員重災區，裁員人數在一萬左右。具體而言，谷歌近日披露的財報指出，2023年谷歌解雇了12000多名員工，光是在遣散費和其他費用上就花費了21億美元。而且裁員費用還在不斷增加，2024年剛過去一個月，谷歌就已經花費了7億美元用來裁員。"));
        documents.add(new DocumentModel(11, "CT01-XW·2024-D30-0011", "新聞熱線[2024]000011", "國產手機品牌重新崛起背後：市場正在逐步恢覆活力，競爭也愈發激烈", "2024年伊始，隨著全球經濟的逐漸覆蘇，手機消費市場也展現出勃勃生機。中國信通院最新數據顯示，2023年中國市場手機出貨量實現了6.5%的同比增長，其中5G手機增長勢頭更為強勁，占比高達82.8%。1月25日，國際數據公司（IDC）發布了最新手機季度跟蹤報告，揭示了中國智能手機市場在2023年第四季度的出貨量情況。報告顯示，該季度中國智能手機市場出貨量達到了約7363萬台，同比增長1.2%。這是在連續十個季度同比下降後，中國智能手機市場首次實現反彈。這一積極信號表明，市場正在逐步恢覆活力，各大品牌之間的競爭也愈發激烈。"));
        documents.add(new DocumentModel(12, "CT01-XW·2024-D30-0012", "新聞熱線[2024]000012", "SpaceX將於1月31日向國際空間站發射天鵝號貨運飛船", "1月29日消息，美國太空探索技術公司SpaceX計劃於當地時間1月30日，利用“獵鷹9號”火箭從佛羅裏達州肯尼迪航天中心發射諾斯羅普·格魯曼公司的“天鵝號”貨運飛船至國際空間站。此次任務是執行NG-20商業補給，將運送約8200多磅的物資、設備及科學實驗器材。"));
    }
    ...
    public AjaxResult ajaxColumns(UserTableColumn userColumn)
    {
        ...
        {
            columnList.add(new UserTableColumn("用戶余額", "userBalance"));
        }
...
class UserTableModel
{
    ...
    /** 用戶余額 */
    @Excel(name = "用戶余額", cellType = ColumnType.NUMERIC)
